...
(function () {
  const DICT = {
    ...
    "Download the app →": "Descarga la app →",
    "Now on the App Store": "Ya en el App Store",
    "Download on the": "Descárgala en el",
    "Free on iPhone.": "Gratis en iPhone.",
    "Safer is live on iPhone — free. Download it and add your trusted people today.": "Safer ya está disponible en iPhone — gratis. Descárgala y agrega hoy a tus personas de confianza.",
    ...
    // ---- never walk alone ----
    "Meet Watch Me": "Conoce Watch Me",
    "Never walk alone.": "Nunca camines sola.",
    "Someone\'s with you, the whole way.": "Alguien te acompaña, todo el camino.",
    "Turn on Watch Me whenever you want to feel safer": "Activa Watch Me cuando quieras sentirte más segura",
    "— heading out, walking alone, or any time something feels off. While it's on, it watches over you, so you're never really alone.": "— al salir, caminando sola o cuando algo no anda bien. Mientras está activo, te cuida, para que nunca estés realmente sola.",
    "See how Watch Me works": "Cómo funciona Watch Me",
    "Step 1": "Paso 1", "Step 2": "Paso 2", "Step 3": "Paso 3",
    "You turn it on": "Tú lo activas",
    "Going out, alone, or feeling uneasy? Start Watch Me whenever you want — you're in control.": "¿Sales, estás sola o te sientes incómoda? Activa Watch Me cuando quieras: tú tienes el control.",
    ...
    "No time for a button. Just say your word or shake your phone — Safer alerts your people and takes over.": "No hay tiempo para un botón. Solo di tu palabra o agita el teléfono: Safer avisa a los tuyos y se encarga.",
    "Watch Me": "Watch Me",
    ...
    "Walking home alone late at night": "Volviendo sola a casa de noche",
    "Something feels off and you don't know why": "Algo no anda bien y no sabes por qué",
    ...
    "Your elderly parent living alone, and you worry every night": "Tu padre o madre, ya mayor, que vive solo/a, y te preocupas cada noche",
    "When something happens, there is no time to waste.": "Cuando algo pasa, no hay tiempo que perder.",

    // ---- AI watch me ----
    "AI Watch Me Mode": "Modo Watch Me con IA",
    "During the moments that matter most, set Safer to AI Watch Me Mode.": "En los momentos que más importan, activa el Modo Watch Me con IA de Safer.",
    "When you feel in danger, you should not need to explain everything.": "Cuando te sientes en peligro, no deberías tener que explicarlo todo.",
    ...
    "Start Watch Me": "Activa Watch Me",
    ...
    "Even if you're stressed or unsure, the right people get the context to respond fast.": "Aunque estés estresada o insegura, las personas indicadas reciben el contexto para responder rápido.",
    ...
    "Solo doesn't mean alone.": "Ir en solitario no significa estar solo.",
    ...
    "Get a nudge the moment your kids reach home or school.": "Recibe un aviso en cuanto tus hijos lleguen a casa o al colegio.",
    ...
    // step labels
    "Start": "Empieza", "Signal": "Da la señal", "Reach": "Llega",
    ...
    "Tap SOS": "Toca SOS",
    "One tap alerts the people you trust with your exact location. A short countdown makes an accidental tap easy to cancel.": "Un toque avisa a las personas en quienes confías con tu ubicación exacta. Una cuenta regresiva corta permite cancelar fácilmente un toque accidental.",
    // alert chain
    ...
    "Built with real communities in mind: a family at home, a synagogue, a school, a Chabad house whose doors are always open.": "Pensado para comunidades reales: una familia en casa, una sinagoga, una escuela, una casa Chabad cuyas puertas siempre están abiertas.",
